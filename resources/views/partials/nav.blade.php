  ...
  <div class="max-w-screen-xl mx-auto px-4">
    <div class="flex items-center overflow-x-auto">
      ...
      @foreach([
        ...
        <a href="{{ $url }}" class="text-slate-300 hover:text-white text-sm font-medium px-4 py-3.5 hover:bg-slate-800 transition-colors whitespace-nowrap flex-shrink-0 border-b-2 border-transparent hover:border-red-500">
          {{ strtoupper($label) }}
        </a>
      @endforeach
